...
class Blueposts_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->name, plugin_dir_url( __FILE__ ) . 'css/blueposts-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->name, plugin_dir_url( __FILE__ ) . 'js/blueposts-public.js', array( 'jquery' ), $this->version, false );
